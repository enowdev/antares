...
func (s *Server) routes() {
	...
	m.HandleFunc("POST /api/vps/folders", s.handleCreateVPSFolder)
	m.HandleFunc("PUT /api/vps/folders/{id}", s.handleRenameVPSFolder)
	m.HandleFunc("PUT /api/vps/folders/{id}/move", s.handleMoveVPSFolder)
	m.HandleFunc("DELETE /api/vps/folders/{id}", s.handleDeleteVPSFolder)
	m.HandleFunc("PUT /api/vps/hosts/{id}/move", s.handleMoveVPSHost)
